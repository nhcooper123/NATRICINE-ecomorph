...
ds2 <-
  ...
  dplyr::select(Species, ecomorph = Habit, PC1:PC8) %>%
...
# Save figure
# ggsave(diet_plot, filename = "outputs/GMM/Figures/PC1-PC8-diet-LM.png", width = 6)
...
# Save figure
# ggsave(filename = "outputs/GMM/Figures/PC123-ecomorph-diet-LM.png", height = 9, width = 13)
