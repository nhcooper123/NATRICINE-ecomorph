...
# Habit
# FitGLS model
model1 <- mvgls(as.matrix(pc_data_habit[, 2:75]) ~ habit, data = pc_data_habit, tree = tree_habit, 
                model = "BM", method = "LOO")
...
# Diet
# FitGLS model
model2 <- mvgls(as.matrix(pc_data_diet[, 2:75]) ~ diet, data = pc_data_diet, tree = tree_diet, 
                model = "BM", method = "LOO")
# Test using permutations
...
# Habit & diet 
# FitGLS model
model3 <- mvgls(as.matrix(pc_data_diet[, 2:75]) ~ Habit + diet, data = pc_data_diet, 
